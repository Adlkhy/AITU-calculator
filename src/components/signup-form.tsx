              ...
              <FieldGroup className="gap-3">
                <div className="space-y-3 text-left md:text-left">
                  ...
                  <p className="max-w-sm text-sm leading-5 tracking-tight text-muted-foreground">
                    Join Evalis to track your academic performance, compete on real-time leaderboards, and build subject templates with AI — all in one place.
                  </p>
                ...
                <FieldDescription className="text-center text-sm text-muted-foreground">
                  Already in the game? <Link to={"/login"}>Log in</Link>
                </FieldDescription>
              </FieldGroup>
            </div>
          </form>
