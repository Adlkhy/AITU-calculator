...
class App {
  ...
  onWheel(e: Event) {
    ...
    const delta = wheelEvent.deltaY || (wheelEvent as WheelEvent & { wheelDelta?: number; detail?: number }).wheelDelta || (wheelEvent as WheelEvent & { wheelDelta?: number; detail?: number }).detail || 0;
